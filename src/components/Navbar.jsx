...
const Navbar = () => {
  ...
  const isTransparent =
    transparentRoutes.includes(location.pathname) && !scrolled;
          ...
          <div className="hidden sm:flex flex-col leading-tight">
            <span
              className={`font-display text-xl font-extrabold tracking-tight ${
                isTransparent ? "text-white" : "text-[#5C2C06]"
              }`}
            >
              Indori Sarafa
            </span>
            <span
              className={`text-[10px] uppercase tracking-[0.25em] ${
                isTransparent ? "text-[#D4AF37]" : "text-[#A52A2A]"
              }`}
            >
              Since 2019
            </span>
                ...
                <>
                  ...
                  {isActive && !isTransparent && (
                    <motion.span
                      ...
                      className="absolute left-3 right-3 -bottom-0.5 h-[2px] bg-[#D4AF37] rounded-full"
                    />
                  )}
                </>
              )}
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="lg:hidden bg-[#FFF8F2] border-t border-[#5C2C06]/10"
