...
const LegalRoute = ({ kind }) => {
  const LegalMod = lazy(() =>
    import("./pages/Legal").then((m) => ({ default: kind === "privacy" ? m.Privacy : m.Terms }))
  );
  return (
    ...
    <div className="App">
      <BrowserRouter>
        ...
        <Layout>
          <Suspense fallback={<PageLoader />}>
            <Routes>
              ...
              <Route path="/privacy-policy" element={<LegalRoute kind="privacy" />} />
        ...
        <Toaster
          ...
          toastOptions={{ style: { background: "#5C2C06", color: "#FFF8F2", border: "1px solid #D4AF37" } }}
        />
      </BrowserRouter>
    </div>
  );
